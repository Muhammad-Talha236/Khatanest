  ...
  return (
    <div>
      <div style={{
        ...
        <div>
          <h2 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 900, fontSize: 26, color: 'var(--text)', margin: 0 }}>
            Payments
          </h2>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 24 }}>
        <div style={{ background: 'var(--surface)', border: '1px solid var(--accent-glow)', borderRadius: 16, padding: 20 }}>
          <div style={{ fontSize: 12, color: 'var(--text-muted)', marginBottom: 6, textTransform: 'uppercase', letterSpacing: 0.8, fontWeight: 600 }}>
            Received This Month
          </div>
          <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 900, fontSize: 28, color: 'var(--accent)' }}>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid rgba(255,92,106,0.3)', borderRadius: 16, padding: 20 }}>
          ...
          <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 900, fontSize: 28, color: 'var(--text)' }}>
            {pagination.total || 0}
          </div>
        </div>
      </div>
