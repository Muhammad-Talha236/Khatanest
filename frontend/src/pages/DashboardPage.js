// pages/DashboardPage.js - Fixed responsive dashboard
  ...
  return (
    <div style={{ maxWidth: '100%', overflowX: 'hidden' }}>
      ...
      <div style={{ 
        ...
        <StatCard icon="💰" label="Cash" value={`Rs. ${(adminBalance).toLocaleString()}`} color="#2ECC9A" />
        <StatCard icon="📊" label="Monthly" value={`Rs. ${(stats?.monthlyTotal || 0).toLocaleString()}`} color="#5B8DEF" />
        <StatCard icon="📥" label="Receivable" value={`Rs. ${(stats?.totalReceivable || 0).toLocaleString()}`} color="#FFB547" />
        <StatCard icon="👥" label="Members" value={stats?.totalMembers || 0} color="#E879F9" />
      </div>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <div style={{ fontSize: isMobile ? 11 : 12, color: 'var(--text-muted)' }}>
              {isMobile ? 'Last 7 days' : 'Last 7 days breakdown'}
            </div>
          </div>
        ...
        {/* Member Balances - Single column on mobile */}
        <div style={{ 
          background: 'var(--surface)', 
          border: '1px solid var(--border)', 
          borderRadius: 16, 
              ...
              {history.map((t, i) => (
                <div key={i} style={{
                  ...
                  <div style={{ 
                    ...
                    <span style={{ fontSize: isMobile ? 18 : 20 }}>{t.type === 'payment' ? '💵' : '🧾'}</span>
                  ...
                  <div style={{ 
                    ...
                    textAlign: isSmallMobile ? 'right' : 'right',
